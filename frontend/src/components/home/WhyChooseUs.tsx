...
const FEATURES = [
  ...
  { icon: Phone,         title: '24/7 Online Booking',     desc: 'Book your appointment anytime using HotDoc — no need to call during business hours.' },
]
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <AnimatedSection direction="left">
            <div className="relative">
              <div className="aspect-square max-w-md mx-auto rounded-3xl bg-hero-gradient p-10 text-white overflow-hidden relative">
                <div className="absolute inset-0 bg-medical-pattern opacity-20" />
                <div className="relative z-10">
                  <div className="text-6xl font-black mb-2">15+</div>
                  <div className="text-xl font-semibold text-teal-200 mb-6">Years Serving Lakemba</div>
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={label} className="flex items-center justify-between py-2 border-b border-white/15 last:border-0">
                        ...
                        <span className="font-bold text-teal-300">{value}</span>
                      </div>
                    ))}
                  </div>
                </div>
