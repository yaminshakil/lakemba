...
import { getFaqs, adminCreateFaq, adminUpdateFaq, adminDeleteFaq } from '@/lib/api'
...
export default function AdminFaqsPage() {
  ...
  const handleDelete = async (id: number) => {
    ...
    setDeleting(id)
    try { await adminDeleteFaq(id); refetch() }
                ...
                <div className="card overflow-hidden">
                  <div className="flex items-center gap-3 p-4">
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      ...
                      <button onClick={() => handleDelete(faq.id)} disabled={deleting === faq.id} className="w-7 h-7 rounded-lg bg-red-50 flex items-center justify-center text-red-500 hover:bg-red-500 hover:text-white transition-colors">
