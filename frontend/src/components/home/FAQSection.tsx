...
const DEFAULT_FAQS: Faq[] = [
  ...
  { id: 2, question: 'How do I book an appointment?', answer: 'You can book online 24/7 via HealthEngine (click the "Book Appointment" button on our website), call us during business hours at 02 7265 1000, or walk in during opening hours. Same-day appointments are often available for urgent matters.', category: 'Appointments', order: 2 },
